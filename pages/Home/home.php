                ...
                <div class="carousel-inner">
                  <div class="carousel-item active"  data-bs-interval="7000">
                    ...
                    <div class="carousel-caption d-none d-md-block text-bg-dark bg-opacity-75 rounded-5">
                        <h5>Places</h5>
                        <p>Discover interesting facts about different places around the world, including their history, culture, and other interesting tidbits</p>
                    </div>
                  </div>
                  ...
                  <div class="carousel-item" data-bs-interval="7000">
                    ...
                    <div class="carousel-caption d-none d-md-block text-bg-dark bg-opacity-75 rounded-5">
                      <h5>Traditions</h5>
                      <p>Learn more about the customs, beliefs, and practices of different cultures and societies around the world</p>
                    </div>
                  </div>
                  ...
                  <div class="carousel-item" data-bs-interval="7000">
                    ...
                    <div class="carousel-caption d-none d-md-block text-bg-dark bg-opacity-75 rounded-5">
                      <h5>Health</h5>
                      <p>Get the facts on the latest health trends and breakthroughs, as well as tips for maintaining a healthy lifestyle</p>
                    </div>
                  </div>
                  ...
                  <div class="carousel-item" data-bs-interval="7000">
                    ...
                    <div class="carousel-caption d-none d-md-block text-bg-dark bg-opacity-75 rounded-5">
                      <h5>Technology</h5>
                      <p>Stay up to date on the latest tech trends, from gadgets to apps and from the internet to artificial intelligence</p>
                    </div>
                  </div>
                  ...
                  <div class="carousel-item" data-bs-interval="7000">
                    ...
                    <div class="carousel-caption d-none d-md-block text-bg-dark bg-opacity-75 rounded-5">
                      <h5>Science</h5>
                      <p>Get to know the basics of science and learn more about the amazing discoveries made every day by scientists around the world</p>
                    </div>
                  </div>
                  ...
                  <div class="carousel-item" data-bs-interval="7000">
                    ...
                    <div class="carousel-caption d-none d-md-block text-bg-dark bg-opacity-75 rounded-5">
                      <h5>Music</h5>
                      <p>Learn more about the history, genres, and artists of the music world, as well as tips for creating your own musical masterpieces</p>
                    </div>
                  </div>
                  ...
                  <div class="carousel-item" data-bs-interval="7000">
                    ...
                    <div class="carousel-caption d-none d-md-block text-bg-dark bg-opacity-75 rounded-5">
                      <h5>Nature</h5>
                      <p>Get to know the natural world, from the plants and animals to the weather and the environment</p>
                    </div>
                  </div>
                  ...
                  <div class="carousel-item" data-bs-interval="7000">
                    ...
                    <div class="carousel-caption d-none d-md-block text-bg-dark bg-opacity-75 rounded-5">
                      <h5>Space</h5>
                      <p>Discover the secrets of the universe, from the planets and stars to the galaxies and beyond</p>
                    </div>
                  </div>

                  <div class="carousel-item" data-bs-interval="7000">
                    <img src="img/Games.jpg" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block text-bg-dark bg-opacity-75 rounded-5">
                      <h5>Games</h5>
                      <p>From classic board games, to modern video games, we provide a look at the world of gaming</p>
                    </div>
                  </div>
                </div>
