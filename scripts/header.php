...
<header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 py-md-0 mb-4 border-bottom">
    <div class="col-md-3"><a href="#"><img src="../../img/icon/T.png" alt="Thing" class="text-primary" width="80px"></a></div>
    <ul class="nav col-12 col-md-auto mb-2 py-3 justify-content-center mb-md-0">
